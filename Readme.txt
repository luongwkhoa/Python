...
Các thư viện: tkinter, pil, pygame, pyttsx3, googletrans, speech_recognition, qrcode, cv2, numpy, pyzbar.

## Lưu ý: Cần mở toàn bộ folder project để có thể chạy được tốt nhất.